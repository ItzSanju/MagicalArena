...
public class Game {
    ...
    public void play() {
        while (playerA.getHealth() > 0 && playerB.getHealth() > 0) {
            ...
            System.out.println(attacker + " attacks with roll " + attackRoll + ", " + defender + " defends with roll " + defenseRoll);
            System.out.println("Damage dealt: " + damageTaken);
            System.out.println("Remaining health - Player A: " + playerA.getHealth() + ", Player B: " + playerB.getHealth());
